...
const SCRIPTURE_FEATURES = [
  ...
  { title: 'Morphological Concordance Search', body: 'Tap any Hebrew or Greek word to open its word-info strip, then tap the + button next to any morphological property — Stem, Aspect, Tense, Mood, Case, and more — to build a search filter. Combine multiple properties (e.g. Verb + Hithpael + Inf. Construct) and tap "Search HOT" or "Search GNT" to find every occurrence of that grammatical form across the entire corpus. Toggle "This word only" to narrow results to that specific lemma in that form. Results open in a grouped sheet by book, tappable to navigate to the verse.' },
