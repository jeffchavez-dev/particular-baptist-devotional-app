...
export const HIGHLIGHT_COLORS = [
  {
    ...
    dot:    '#d4a000',
    rowBg:  'rgba(220,170,0,0.22)',
    border: 'rgba(180,130,0,0.75)',
    numBg:  'rgba(220,170,0,0.35)',
    numClr: 'rgba(130,90,0,0.95)',
  },
  {
    id: 'green', label: 'Green',
    dot:    '#2a9e62',
    rowBg:  'rgba(35,160,80,0.20)',
    border: 'rgba(25,120,55,0.72)',
    numBg:  'rgba(35,160,80,0.32)',
    numClr: 'rgba(18,90,42,0.95)',
  },
  {
    id: 'blue', label: 'Blue',
    dot:    '#2e78d4',
    rowBg:  'rgba(40,110,210,0.20)',
    border: 'rgba(25,80,175,0.72)',
    numBg:  'rgba(40,110,210,0.32)',
    numClr: 'rgba(18,58,145,0.95)',
  },
  {
    id: 'pink', label: 'Pink',
    dot:    '#d03a72',
    rowBg:  'rgba(205,50,110,0.20)',
    border: 'rgba(170,30,85,0.72)',
    numBg:  'rgba(205,50,110,0.32)',
    numClr: 'rgba(140,20,70,0.95)',
  },
  {
    id: 'purple', label: 'Purple',
    dot:    '#7040d8',
    rowBg:  'rgba(110,60,210,0.20)',
    border: 'rgba(82,40,170,0.72)',
    numBg:  'rgba(110,60,210,0.32)',
    numClr: 'rgba(65,28,145,0.95)',
  },
]
